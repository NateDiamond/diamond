...
type ButtonParams = {className?: string, description?: string, color: string, secondaryColor: string, brightness: BRIGHTNESS, children: ReactElement, onPress?: MouseEventHandler<HTMLButtonElement>, pressable?: boolean};

export function Button({className, description, children, color, secondaryColor, brightness, onPress, pressable = true}: ButtonParams) {
